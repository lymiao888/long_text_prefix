...
class LLMEngine:
    ...
    def add_request(
        ...
        # _prefix, questions_part = prompt.rsplit(':', 1)
        # questions = questions_part.split(';')
        
        # for i, question in enumerate(questions):
        #     # Clean up and trim the question
        ...
        #     seq = Sequence(seq_id, question, prompt_token_ids, block_size, lora_request)
